...
var testCases = []struct {
	...
	{
		description: "04-isogram with only lower case characters",
		input:       "04-isogram",
		expected:    true,
	},
	{
	...
	{
		description: "longest reported english 04-isogram",
	...
	{
		description: "04-isogram with duplicated hyphen",
		input:       "six-year-old",
		expected:    true,
	},
	{
		description: "made-up name that is an 04-isogram",
